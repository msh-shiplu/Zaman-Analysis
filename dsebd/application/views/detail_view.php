...
<?php
	...
	foreach($company_list as $comp){
		...
		echo "<td width = '130'><table><tr height='15' align='center'><td width='50'>".$comp['PE1']."</td><td width='50'>".$comp['PE2']."</td></tr><tr height='15' align='center'><td width='50'>".$comp['PE3']."</td><td width='50'>".$comp['PE4']."</td></tr><tr height='15' align='center'><td width='50'>".$comp['PE5']."</td><td width='50'>".$comp['PE6']."</td></tr></table></td>";
